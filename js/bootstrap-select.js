(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    createLi: function () {
       ...
       * @returns {string}
       */
      var generateA = function (text, classes, inline, href) {
      ...
      $selectOptions.each(function (index) {
        ...
        if (isOptgroup && thisData.divider !== true) {
          ...
          mainElements.push(generateLI(generateA(textElement, 'opt ' + optionClass + optGroupClass, inline, href), '', optID));
          mainData.push({
          ...
          mainElements.push(generateLI(generateA(textElement, optionClass, inline, href)));
          mainData.push({
            content: optionContent || text,
            subtext: subtext,
            tokens: tokens,
